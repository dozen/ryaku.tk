...
<html lang="ja">
    ...
    <body>
        ...
        <div class="back" style="font-size: 13px;top: 340px;left:-10px">ODA: Official Development Assistance</div>
        ...
        <div class="back" style="font-size: 22px;top: 80px;left:911px">ACPI: Advanced Configuration and Power Interface</div>
        ...
        <div class="back" style="font-size: 15px;top: 572px;left:1100px">ODBC: Open Database Connectivity</div>
        ...
        <div id="container">
            ...
            <div id="footer">
                <a href="https://twitter.com/_dozen_" target="_blank">@_dozen_</a>
            </div>
        </div>
    </body>
</html>
